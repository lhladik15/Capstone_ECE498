...
print('Length Scaled: ', len(scaled))
...
print('length reframed: ', len(reframed['var1(t)']))
n_train_days = int(0.9*len(reframed))
print('Train days: ', n_train_days)
...
#print('Test dimensions: ', test_X.shape)
test_X = test_X.reshape(test_X.shape[0], n_days*n_features)
#print('Reshape test dimensions: ', test_X.shape)
...
print('Hiiiiiiii', dataset)


##--------STEP 2: Univariate LSTM
from pandas import DataFrame
...
def timeseries_to_supervised_uni(data, lag=1):
    df = DataFrame(data)
...
series = dataset
print('Series', series)
print('length Series: ', len(series))
...
supervised = timeseries_to_supervised_uni(diff_values, 1)
