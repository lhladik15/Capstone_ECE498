...
dataset = read_csv('NOVT_train.csv', header=0, parse_dates=[0], index_col=0, squeeze=True, date_parser= parser)
newPrices = read_csv('NOVT.csv', header=0, parse_dates=[0], index_col=0, squeeze=True, date_parser= parser)
print(newPrices)
print(type(dataset))
